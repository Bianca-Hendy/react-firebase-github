...
import LogoIfsul from '../imagens/gato-preto-2.jpg'
...
import { logout, auth, signInWithGithub } from "../../src/firebaseConfig";
                        ...
                        <Box sx={{ flexGrow: 0 }}>
                            <Tooltip title="Menu do usuário">
                                <IconButton onClick={handleOpenUserMenu} sx={{ p: 0 }}
                                    ...
                                    <Typography >Usuário : {user? 
                                                            user?.displayName : "Não autenticado"}</Typography>
